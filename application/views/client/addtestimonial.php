...
?>
  <div class="container-fluid">
    ...
    <div class="row marketing">
      <div class="col-lg-8 col-lg-offset-2">
        <p class="well well-sm" style="margin: 0 16px">
          <span class="glyphicon glyphicon-info-sign" style="font-size:1.5em"></span> &nbsp; Testimoni hanya dapat dilakukan terhadap pengiriman yang anda pesan.
        </p>
      </div>
    </div>
    <!-- /Info -->
    ...
    <!-- Form pengaduan -->
    <div class="row marketing">
      <form action="<?php echo site_url('User/insertTestimonial'); ?>" method="POST">
        <div class="col-lg-8 col-lg-offset-2">
          ...
          <div class="col-lg-6">
            <div class="form-group">
              <label for="testimonial" class="sr-only">Testimoni</label>
              <textarea name="testimonial" id="testimonial" cols="30" rows="10" class="form-control" placeholder="Tulis testimoni anda disini" required></textarea>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              <label for="send-complaint" class="sr-only">Kirim Testimoni</label>
